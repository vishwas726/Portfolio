    ...
    <div className="max-w-[1200px] mx-6 xl:mx-auto text-white">
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-10 gap-y-10 w-full mt-20">
        <div className="projectWrapper before:contrast-[''] before:absolute before:bg-[#0000ffaf] group before:hover:w-full before:transition-all before:duration-200 relative before:opacity-30 before:w-0 before:top-0 before:left-0 before:h-full col-span-2">
         ...
         <p className="font-bold text-[0px] transition-all duration-200 group-hover:text-[10rem] md:group-hover:text-[18rem] font-Passion absolute top-0 right-20">01</p>
        </div>
        ...
        <div className="projectWrapper before:contrast-[''] before:absolute before:bg-[#0000ffaf] group before:hover:w-full before:transition-all before:duration-200 relative before:opacity-30 before:w-0 before:top-0 before:left-0 before:h-full col-span-2 mt-10">
         ...
         <p className="font-bold text-[0px] transition-all duration-200 group-hover:text-[10rem] md:group-hover:text-[18rem] font-Passion absolute top-0 right-20">02</p>
        ...
        <div className="projectWrapper before:contrast-[''] before:absolute before:bg-[#0000ffaf] group before:hover:w-full before:transition-all before:duration-200 relative before:opacity-30 before:w-0 before:top-0 before:left-0 before:h-full col-span-2 mt-20">
          ...
          <img
            ...
            className="cursor-pointer transition-all duration-200 rounded-lg w-full"
          />
         <p className="font-bold text-[0px] transition-all duration-200 group-hover:text-[10rem] md:group-hover:text-[18rem] font-Passion absolute top-0 right-20">03</p>
        ...
        <div className="projectWrapper before:contrast-[''] before:absolute before:bg-[#0000ffaf] group before:hover:w-full before:transition-all before:duration-200 relative before:opacity-30 before:w-0 before:top-0 before:left-0 before:h-full col-span-2 mt-10">
          ...
          <img
            ...
            className="cursor-pointer transition-all duration-200 rounded-lg w-full"
          />
         <p className="font-bold text-[0px] transition-all duration-200 group-hover:text-[10rem] md:group-hover:text-[18rem] font-Passion absolute top-0 right-20">04</p>
        ...
        <div className="projectWrapper before:contrast-[''] before:absolute before:bg-[#0000ffaf] group before:hover:w-full before:transition-all before:duration-200 relative before:opacity-30 before:w-0 before:top-0 before:left-0 before:h-full col-span-2 mt-20">
          ...
          <img
            ...
            className="cursor-pointer transition-all duration-200 rounded-lg w-full"
          />
         <p className="font-bold text-[0px] transition-all duration-200 group-hover:text-[10rem] md:group-hover:text-[18rem] font-Passion absolute top-0 right-20">05</p>
...
<div className=""></div><div className=""></div>
        <div className="projectWrapper before:contrast-[''] before:absolute before:bg-[#0000ffaf] group before:hover:w-full before:transition-all before:duration-200 relative before:opacity-30 before:w-0 before:top-0 before:left-0 before:h-full col-span-2 mt-10">
         ...
         <p className="font-bold text-[0px] transition-all duration-200 group-hover:text-[10rem] md:group-hover:text-[18rem] font-Passion absolute top-0 right-20">06</p>
